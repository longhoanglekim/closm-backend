...
INSERT INTO product_variants (product_id, price, image_url, size, color, quantity, name, description) VALUES
                                                                                                          ...
                                                                                                          (2, 399000, 'https://res.cloudinary.com/dwddrjz3b/image/upload/v1743148505/C0027D_ryifjz.jpg', 'XL', 'Navy Blue', 'XL', 'Navy Blue', 30, 'Navy Blue Sporty Hoodie', 'Sporty style hoodie'),
